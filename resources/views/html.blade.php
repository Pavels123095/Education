...
<head>
	...
	<link rel="favicon" href="{{asset('verstka/assets/images/favicon.png')}}">
...
<body>
  ...
  <div class="container">
    ...
    <script src="{{asset('verstka/assets/js/bootstrap.min.js')}}"></script> 
	  <script src="{{asset('verstka/assets/js/custom.js')}}"></script>
    <script>
      jQuery(function(){
