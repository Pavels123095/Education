                ...
                <div class="text-center">
                  {{ dump($user) }}
                    <img class="profile-user-img img-fluid img-circle" 
                      src="{{($user->avatar->isNotEmpty()) ? $user->avatar : '/images/not-user-avatar.png'}}" alt="User profile picture">
                </div>
              ...
              <div class="card-body">
                <div class="tab-content">
                  <div class="tab-pane active" id="settings">
                    <form class="form-horizontal" action="{{route('profile.edit',$user->id)}}">
                      @csrf
                      @method('PUT')
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" value="{{$user->name}}" 
                            class="form-control" id="inputName" name="nane" placeholder="Имя">
                        </div>
                      </div>
                      <div class="form-group row">
