  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="MenuAddForm" name="MenuAddForm" action="<?php echo e(route('menu.store')); ?>" method="POST">
          <?php echo csrf_field(); ?>
...
</div><?php /**PATH /home/p/payusovs95/anton.prizraks.ru/resources/views/admins/option/menu/create.blade.php ENDPATH**/ ?>