<?php $__env->startSection('title', 'Добавление лекции'); ?>
        ...
        <form action="<?php echo e(route('lessons.store')); ?>" method="post">
          ...
          <div class="card-body">
            <div class="form-group">
              <input name="name" type="text" class="form-control" id="namelessons" placeholder="Название Лекции" required>
            </div>
            <div class="form-group">
              <textarea rows="4" name="description" class="editor form-control col-lg-12" placeholder="Введите описание">
              </textarea>
            </div>
            <div class="form-group">
              <?php if(empty($tasks)): ?>
            ...
            <div class="form-group">
              ...
              <div class="input-group d-flex">
                <input type="text" name="images" value="" class="form-control col-10" id="exampleInputFile" readonly> 
            ...
            <div class="form-group">
              ...
              <div class="input-group d-flex">
                <input type="text" name="videos" value="" class="form-control col-10" id="videoFile" readonly> 
...
<?php echo $__env->make('admins.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/p/payusovs95/anton.prizraks.ru/resources/views/admins/lessons/create.blade.php ENDPATH**/ ?>