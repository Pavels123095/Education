...
<?php $component->withAttributes([]); ?>
    <body class="hold-transition sidebar-mini layout-fixed">
        <div class="wrapper">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg py-2 px-2" aria-labelledby="dropdownMenuButton">
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            <div class="user-footer d-flex">
                                <a href="<?php echo e(route('profiles')); ?>" class="btn btn-default btn-sm mr-auto">Профиль</a>
            ...
            <?php echo $__env->make('admins.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php endif; ?>
</html><?php /**PATH /home/p/payusovs95/anton.prizraks.ru/resources/views/admins/app.blade.php ENDPATH**/ ?>