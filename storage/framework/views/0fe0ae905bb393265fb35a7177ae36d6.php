...
<head>
	...
	<link rel="favicon" href="<?php echo e(asset('verstka/assets/images/favicon.png')); ?>">
...
<body>
  ...
  <div class="container">
    ...
    <script src="<?php echo e(asset('verstka/assets/js/bootstrap.min.js')); ?>"></script> 
	<script src="<?php echo e(asset('verstka/assets/js/custom.js')); ?>"></script>
    <script>
      jQuery(function(){
...
</html><?php /**PATH /home/p/payusovs95/anton.prizraks.ru/resources/views/html.blade.php ENDPATH**/ ?>